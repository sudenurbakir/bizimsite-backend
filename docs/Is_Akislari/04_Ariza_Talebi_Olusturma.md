...
Bu doküman, BizimSite Backend projesinde kullanıcıların arıza talebi oluşturma sürecinin backend tarafında nasıl yönetileceğini açıklamak amacıyla hazırlanmıştır.
...
- Arıza talepleri yalnızca kimliği doğrulanmış kullanıcılar tarafından oluşturulabilecektir.
